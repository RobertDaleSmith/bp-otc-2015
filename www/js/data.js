BP.data = {
	...
	deployments: [
		...
		{   "id":"northSea",
		    ...
		    "disclaimer":"Designer gas is a registered trade mark of BP plc | ISS, Designer Water, and LoSal are registered trade marks of BP plc",
		    "location":{
		        "x":"953",
		        "y":"135"
		    },
		...
		{   "id":"norway",
		    ...
		    "disclaimer":"Designer Gas is a registered trade mark of BP plc",
		    "location":{
		        "x":"971",
		        "y":"167"
		    },
	...
	projects: [
			...
			"locations":[
				...
				{   "id":"azerbaijan",
					...
					"statuses":[
						...
						{
							"color": "blue",
							"status": [{"type":"4DS","text":"4D Seismic - Deployment"}]
						}
					],
				    "location":{
				        "x":"1207",
					...
					"statuses":[
						{
							"color": "green",
							"status": [
								{"type":"ISSN","text":"ISSN™ - Deployment"}
							]
						}
					],
				    "location":{
				...
				{   "id":"northSea",
					...
					"statuses":[
						...
						},
						{
							"color": "blue",
							"status": [
								{"type":"WATS","text":"Wide Azimuth Towed Streamer - Field Trial Complete"}, 
								{"type":"4DS","text":"4D Seismic - Deployment"}
							]
						}
					],
				    "location":{
					...
					"sequences": [
						{
							...
							"arrows": [
								...
								{
									"order": 3,
									"path": "M 624 431 C 538 462 498 399 479 359"
								},
								{
									"order": 4,
									"path": "M 471 341 C 388 163 786 216 934 159"
								},
								{
									"order": 5,
								...
								{
									"order": 6,
									"path": "M 1689 500 C 1729 825 959 809 1012 569"
								},
								{
									"order": 7,
									"path": "M 1016 548 C 1027 445 1287 400 1138 322"
								},
								{
									"order": 8,
					...
					"statuses":[
						{
							"color": "green",
							"status": [
								{"type":"CRC","text":"Casing Running Console - Deployment"}
							]
						}
					],
				    "location":{
				...
				{   "id":"azerbaijan",
					...
					"statuses":[
						...
						},						
						{
							"color": "blue",
							"status": [
								{"type":"NDS","text":"No Drilling Surprises - Deployment"}
							]
						}
					],
				    "location":{
					...
					"statuses":[
						{
							"color": "green",
							"status": [
								{"type":"BOP","text":"BOP Monitoring - Field Trial Complete"}
							]
						}
					],
				    "location":{
					...
					"statuses":[
						{
							...
							"status": [
								{"type":"CRC","text":"Casing Running Console - Deployment"}, 
								{"type":"BOP","text":"BOP Monitoring - Deployment"}
							]
						},
						{
							"color": "blue",
							"status": [
								{"type":"PTC","text":"Pressure Testing Console - Deployment"}, 
								{"type":"RFM","text":"Rigsite Fluid Management - Field Trial"}, 
								{"type":"NDS","text":"No Drilling Surprises - Deployment"}
							]
						}
					],
				...
				{   "id":"norway",
					...
					"statuses":[
						...
						},
						{
							"color": "blue",
							"status": [
								{"type":"CCo","text":"Cementing Console - Deployment"}
							]
						}
					],
				    "location":{
					...
					"statuses":[
						{
							"color": "blue",
							"status": [
								{"type":"ROP","text":"ROP Optimization - Field Trial"}
							]
						}
					],
				    "location":{
				...
				{   "id":"azerbaijan",
					...
					"statuses":[
						...
						},
						{
							"color": "blue",
							"status": [
								{"type":"DSMo","text":"Field Trial Complete"}
							]
						}
					],
				    "location":{
		...
		{	"id":"eor",
			...
			"color": "f26721",
			"disclaimer":"Designer Gas is a registered trade mark of BP plc | Bright Water is a trade mark of Nalco Energy Services | Designer Water and LoSal are registered trade marks of BP plc ",
			"locations":[
